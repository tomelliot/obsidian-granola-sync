...
describe("DocumentProcessor", () => {
  ...
  describe("prepareNote", () => {
    ...
    it("should escape attendee names with asterisks in prepareNote", () => {
      const doc: GranolaDoc = {
        id: "doc-123",
        title: "Test Note",
        people: {
    ...
    it("should escape attendee names with colons in prepareNote", () => {
      const doc: GranolaDoc = {
        id: "doc-123",
        title: "Test Note",
        people: {
    ...
    it("should escape attendee names with quotes in prepareNote", () => {
      const doc: GranolaDoc = {
        id: "doc-123",
        title: "Test Note",
        people: {
    ...
    it("should escape attendee names with mixed special characters in prepareNote", () => {
      const doc: GranolaDoc = {
        id: "doc-123",
        title: "Test Note",
        people: {
          attendees: [
            { name: '*John "Johnny" Doe*', email: "john@example.com" },
            { name: "user@example.com: admin", email: "admin@example.com" },
            { name: "O'Brien", email: "obrien@example.com" },
            { name: "Tom & Jerry", email: "tom@example.com" },
          ],
        },
        last_viewed_panel: {
          content: {
      ...
      expect(result.content).toContain("attendees:");
      expect(result.content).toContain('"*John \\"Johnny\\" Doe*"');
      expect(result.content).toContain('"user@example.com: admin"');
  ...
  describe("prepareCombinedNote", () => {
    ...
    it("should escape attendee names with colons", () => {
      const doc: GranolaDoc = {
        ...
        people: {
          attendees: [
            { name: "Jane: Smith", email: "jane@example.com" },
            { name: "Dr: Professor", email: "prof@example.com" },
          ],
        },
        last_viewed_panel: {
          content: {
      ...
      expect(result.content).toContain("attendees:");
      expect(result.content).toContain('"Jane: Smith"');
      expect(result.content).toContain('"Dr: Professor"');
    });
    ...
    it("should escape attendee names with quotes", () => {
      const doc: GranolaDoc = {
        ...
        people: {
          attendees: [
            { name: 'John "Johnny" Doe', email: "john@example.com" },
            { name: '"Quoted Name"', email: "quoted@example.com" },
          ],
        },
        last_viewed_panel: {
          content: {
      ...
      expect(result.content).toContain("attendees:");
      expect(result.content).toContain('"John \\"Johnny\\" Doe"');
      expect(result.content).toContain('"\\"Quoted Name\\""');
    });
      ...
      const doc: GranolaDoc = {
        ...
        people: {
          attendees: [
            ...
            { name: "@mention", email: "mention@example.com" },
          ],
        },
        last_viewed_panel: {
          content: {
    ...
    it("should escape attendee names with hash signs", () => {
      const doc: GranolaDoc = {
        ...
        people: {
          attendees: [
            { name: "#hashtag", email: "hash@example.com" },
            { name: "Name # comment", email: "comment@example.com" },
          ],
        },
        last_viewed_panel: {
          content: {
      ...
      expect(result.content).toContain('"Name # comment"');
    });
    ...
    it("should escape attendee names with brackets", () => {
      const doc: GranolaDoc = {
        ...
        people: {
          attendees: [
            { name: "[Array] Person", email: "array@example.com" },
            { name: "{Object} Person", email: "object@example.com" },
          ],
        },
        last_viewed_panel: {
          content: {
      ...
      expect(result.content).toContain("attendees:");
      expect(result.content).toContain('"[Array] Person"');
      expect(result.content).toContain('"{Object} Person"');
    });
    ...
    it("should escape attendee names with ampersands", () => {
      const doc: GranolaDoc = {
        ...
        people: {
          attendees: [
            { name: "Tom & Jerry", email: "tom@example.com" },
            { name: "&anchor", email: "anchor@example.com" },
          ],
        },
        last_viewed_panel: {
          content: {
    ...
    it("should escape attendee names with apostrophes", () => {
      const doc: GranolaDoc = {
        ...
        people: {
          attendees: [
            { name: "O'Brien", email: "obrien@example.com" },
            { name: "It's Fine", email: "fine@example.com" },
          ],
        },
        last_viewed_panel: {
          content: {
      ...
      expect(result.content).toContain("attendees:");
      expect(result.content).toContain("\"O'Brien\"");
      expect(result.content).toContain("\"It's Fine\"");
    });
